...
class ParadoxPlugin(Plugin):
    ...
    commands = {
        # Moderation
        "ac-op": {"description": "Grant security clearance with password", "usages": ["/ac-op [password: message]"], "permissions": ["paradox.op"]},
        "ac-deop": {"description": "Revoke security clearance", "usages": ["/ac-deop [player: player]"], "permissions": ["paradox.deop"]},
        "ac-ban": {"description": "Ban a player", "usages": ["/ac-ban <player: player> [reason: message]"], "permissions": ["paradox.ban"]},
        "ac-unban": {"description": "Unban a player", "usages": ["/ac-unban <name: message>"], "permissions": ["paradox.unban"]},
        "ac-kick": {"description": "Kick a player", "usages": ["/ac-kick <player: player> [reason: message]"], "permissions": ["paradox.kick"]},
        ...
        "ac-punish": {"description": "Punish a player", "usages": ["/ac-punish <player: player> [action: message]"], "permissions": ["paradox.punish"]},
        "ac-tpa": {"description": "Send teleport request", "usages": ["/ac-tpa <player: player>"], "permissions": ["paradox.tpa"]},
        "ac-allowlist": {"description": "Manage allow list", "usages": ["/ac-allowlist [args: message]"], "permissions": ["paradox.allowlist"]},
        "ac-whitelist": {"description": "Manage whitelist", "usages": ["/ac-whitelist [args: message]"], "permissions": ["paradox.whitelist"]},
        "ac-opsec": {"description": "Security dashboard", "usages": ["/ac-opsec"], "permissions": ["paradox.opsec"]},
        "ac-despawn": {"description": "Remove entities", "usages": ["/ac-despawn [args: message]"], "permissions": ["paradox.despawn"]},
        ...
        "ac-command": {"description": "Enable/disable commands", "usages": ["/ac-command [args: message]"], "permissions": ["paradox.command"]},
        "ac-prefix": {"description": "Change command prefix display", "usages": ["/ac-prefix [prefix: message]"], "permissions": ["paradox.prefix"]},
        # Settings
        ...
        "ac-worldborder": {"description": "Configure world border", "usages": ["/ac-worldborder [args: message]"], "permissions": ["paradox.settings"]},
        ...
        # Utility
        "ac-home": {"description": "Set/teleport to home locations", "usages": ["/ac-home [args: message]"], "permissions": ["paradox.home"]},
        ...
        "ac-channels": {"description": "Private chat channels", "usages": ["/ac-channels [args: message]"], "permissions": ["paradox.channels"]},
        "ac-rank": {"description": "Player rank management", "usages": ["/ac-rank <player: player> [rank: message]"], "permissions": ["paradox.rank"]},
        "ac-debug-db": {"description": "Inspect/modify SQLite database", "usages": ["/ac-debug-db [args: message]"], "permissions": ["paradox.debugdb"]},
