...
<p align="center">
  <a href="https://github.com/TheNINJALLO/endstone-paradox/actions/workflows/wheel-release.yml"><img alt="Build" src="https://img.shields.io/github/actions/workflow/status/TheNINJALLO/endstone-paradox/wheel-release.yml?branch=main&amp;style=for-the-badge&amp;logo=githubactions&amp;logoColor=white&amp;label=Build"></a>
  <a href="https://github.com/TheNINJALLO/endstone-paradox/releases/latest"><img alt="Latest release" src="https://img.shields.io/github/v/release/TheNINJALLO/endstone-paradox?display_name=tag&amp;style=for-the-badge&amp;label=Release"></a>
</p>
...
<p align="center">
  <strong>Paradox AntiCheat - A comprehensive anti-cheat system for Endstone Bedrock servers.</strong>
</p>
...
Paradox AntiCheat - A comprehensive anti-cheat system for Endstone Bedrock servers. This release is aligned with Endstone 0.11.9 and Minecraft Bedrock Dedicated Server 1.26.44, and is distributed as a Python wheel for direct installation in an Endstone server.
...
```bash
gh release download v1.9.3 --repo TheNINJALLO/endstone-paradox --pattern "*.whl"
```
...
├── endstone.toml
├── plugins/
│   └── endstone_paradox-1.9.1-py3-none-any.whl   ← drop it here
└── ...
```
...
```
[ParadoxAC] Paradox AntiCheat v1.9.1 loaded!
