...
Install Clang 20, libc++20, libc++abi20 and OpenSSL 3 development headers. The [pinned remote-dev environment](https://github.com/TheNINJALLO/endstone-paradox/blob/main/native/references.lock.json) documents Endstone's LLVM/libc++ setup; the plugin needs no SSH server or mounted SSH keys.
